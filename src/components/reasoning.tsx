  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-[linear-gradient(to_top,hsl(var(--background)),transparent)]",
  ...
  return (
    <CollapsibleContent
      ...
      className={cn(
        ...
        "group/collapsible-content ease-&lsqb;cubic-bezier(0.32,0.72,0,1)&rsqb; motion-reduce:animate-none",
        "data-[state=closed]:animate-collapsible-up",
        "data-[state=open]:animate-collapsible-down",
        "data-[state=closed]:fill-mode-forwards",
        "data-[state=closed]:pointer-events-none",
        "data-[state=open]:duration-&lsqb;var(--animation-duration)&rsqb;",
        "data-[state=closed]:duration-&lsqb;var(--animation-duration)&rsqb;",
        className,
      )}
      {...props}
    >
